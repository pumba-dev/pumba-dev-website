...
.repo-container {
  @apply flex flex-col justify-between gap-1 min-w-0;
}
...
.repo-desc {
  ...
  /* Reponsivity */
  w-[11rem]  text-[0.75rem]
  xs:w-[12.8rem] xs:text-[0.79rem]
  sm:w-[13.5rem] sm:text-[0.81rem]
  md:w-[12rem] md:text-[0.8rem]
